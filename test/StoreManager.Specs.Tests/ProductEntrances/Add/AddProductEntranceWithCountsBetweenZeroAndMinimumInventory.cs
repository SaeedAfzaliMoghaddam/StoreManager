...
{
    public class AddProductEntranceWithCountsBetweenZeroAndMinimumInventory
        :BusinessIntegrationTest
    {
        private ProductEntranceService _sut;
        private AddProductEntranceDto _dto;
        public AddProductEntranceWithCountsBetweenZeroAndMinimumInventory()
        {
        ...
        [When("تعداد ۵ تا به موجودی کالایی " +
        ...
        [Then("یک کالا با عنوان شامپو و موجودی ۵ " +
            "و وضعیت آماده ی سفارش در گروه بهداشتی و حداقل موجودی ۱۰ " +
            "باید در فهرست کالاها وجود داشته باشد")]
        [And("یک ورودی کالا برای کالای شامپو در" +
            " تاریخ الان  و تعداد ۵ و شماره فاکتور ۱۲۳a" +
