...
{
    public class AddProductEntranceWithCountsEqualsByMinimumInventory 
        : BusinessIntegrationTest
    {
        private ProductEntranceService _sut;
        private AddProductEntranceDto _dto;
        public AddProductEntranceWithCountsEqualsByMinimumInventory()
        {
        ...
        [When("تعداد ۱۰ تا به موجودی کالایی " +
